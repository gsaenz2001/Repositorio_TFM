...
% No guarda imagenes.
% No genera figuras.
% Solo muestra las tablas 15x9 por PCB en Command Window.
%
% Tambien deja las tablas en el workspace:
%   Tabla_M1_2L_4, Tabla_M2_2L_4_06, ...
%   Tablas15x9
%   StatsModa
%   Cambios
...
% Descartar primeras muestras de cada bloque para evitar transitorios.
...
function StatsModa = calcularStatsModaPorBloque(Datos, numPistas, nDescartar, usarFiltroMAD, Kmad)
...
for i = 1:height(comb)
    ...
    for p = 1:numPistas
        ...
        [modaHz, medianaHz, nValidas, nEmpate, cuentaModa] = calcularModaRobusta( ...
            x, ...
            resolucion, ...
            nDescartar, ...
            usarFiltroMAD, ...
...
function [modaHz, medianaHz, nValidas, nEmpate, cuentaModa] = calcularModaRobusta(x, resolucion, nDescartar, usarFiltroMAD, Kmad)
...
% Empate: candidata mas cercana a la mediana.
